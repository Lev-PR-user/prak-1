    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (Act == 1)
            {
                ...
                Console.WriteLine("10: Разработайте программу, которая принимает текст и выводит два слова: наиболее часто встречающееся и самое длинное.");
            ...
            "3. Фаренгейт\n");
                    ...
                    case 10:
                        Console.WriteLine("10: вариант 23:");
                        ...
                        var mostFrequentWord = frequency.OrderByDescending(pair => pair.Value).FirstOrDefault().Key;
